...
// import type { Sandbox } from '../../../utils/code/Sandbox';
// import { getSandboxContext } from '../../../utils/code/Sandbox';
...
export class ToolBlender implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Blender Tool',
		name: 'toolBlender',
		icon: 'fa:cog',
		iconColor: 'black',
		group: ['transform'],
		version: 1,
		description: 'Write a tool to Blender',
		defaults: {
			name: 'Code Tool',
		},
		codex: {
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		console.log("===useSchema:", useSchema);
