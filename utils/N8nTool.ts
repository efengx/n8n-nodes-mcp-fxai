...
import type { ZodTypeAny, ZodObject as ZodObjectType } from 'zod';
...
type N8nToolDynamicStructuredToolInput = DynamicStructuredToolInput<ZodObjectType<any>>;

export class N8nTool extends DynamicStructuredTool<ZodObjectType<any>> {
	constructor(
		private context: ISupplyDataFunctions,
		fields: N8nToolDynamicStructuredToolInput,
	) {
		super(fields);
	}
